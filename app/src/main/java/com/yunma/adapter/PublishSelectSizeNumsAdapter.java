...
import com.yunma.R;
import com.yunma.bean.ModStocksBean;
...
public class PublishSelectSizeNumsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    private List<ModStocksBean> stocksBeenList;

    public PublishSelectSizeNumsAdapter(Context context,OnClickListener onClick) {
    ...
    public void setStocksBeenList(List<ModStocksBean> stocksBeenList) {
