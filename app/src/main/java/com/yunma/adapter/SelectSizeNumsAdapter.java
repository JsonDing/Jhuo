...
public class SelectSizeNumsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    private List<StocksBean> stocksBeenList;

    public SelectSizeNumsAdapter(Context context,OnClickListener onClick) {
    ...
    public void setStocksBeanList(List<StocksBean> stocksBeenList) {
