...
import com.yunma.jhuo.activity.HotGoods;
...
public class EntrepotGoodsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public EntrepotGoodsAdapter(Context mContext, List<ListBean> list, boolean isLastPage) {
        this.list = list;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if(holder instanceof ViewHolder) {
            GlideUtils.glidNormle(mContext, ((ViewHolder) holder).image,
                    ConUtils.GOODS_IMAGE_URL + list.get(position).getPic());
            ...
            ((BottomViewHolder)holder).layoutSeeMore.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(mContext, HotGoods.class);
                    mContext.startActivity(intent);
                }
            });
        }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            int width = (ScreenUtils.getScreenWidth(mContext)- DensityUtils.dp2px(mContext,60))/3;
