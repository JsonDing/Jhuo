...
public class EMMainActivity extends BaseActivity {
    ...
    protected static final String TAG = "EMMainActivity";
    ...
    public void onViewClicked(View view) {
        switch (view.getId()){
            case R.id.layoutBack:
                ...
                break;
            case R.id.layoutAdd:
                startActivity(new Intent(EMMainActivity.this, AddContactActivity.class));
                break;
        }
    }
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    if (ChatActivity.activityInstance != null && ChatActivity.activityInstance.toChatUsername != null &&
                        ...
                        Toast.makeText(EMMainActivity.this, ChatActivity.activityInstance.getToChatUsername() + st10, Toast.LENGTH_LONG)
                                .show();
    ...
    private void showExceptionDialog(String exceptionType) {
        ...
        if (!EMMainActivity.this.isFinishing()) {
            ...
            try {
                if (exceptionBuilder == null)
                    exceptionBuilder = new AlertDialog.Builder(EMMainActivity.this);
