...
public class EditInvoiceModelImpl implements EditInvoiceModel {
    private SuccessResultBean resultBean = null;
    private FailedResultBean failedResultBean = null;
    @Override
    public void editInvoice(Context mContext, AddInvoicesBean addBean,
                            final EditInvoiceListener onListener) {
        RequestParams params = new RequestParams(ConUtils.EDIT_INVOICE);
