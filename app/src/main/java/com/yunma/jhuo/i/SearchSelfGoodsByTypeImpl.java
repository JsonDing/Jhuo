...
public class SearchSelfGoodsByTypeImpl implements SearchGoodsInterface.SearchSelfGoodsByTypeModel {
    private FailedResultBean failedResultBean = null;
    private GetSelfGoodsResultBean resultBean = null;
    @Override
    public void searchSelfByType(final Context mContext, String type, String size, int pages,
                                 final SearchGoodsInterface.OnSearchSelfGoodsByTypeListener onSearchGoodsListener) {
        ...
        LogUtils.log("查询自仓同类商品请求: ------------>" + strLogin);
